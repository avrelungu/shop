...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/src/EventSubscriber/SymfonyHeaderSubscriber.php';
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('order.status_updated', [#[\Closure(name: 'App\\EventListener\\OrderStatusUpdatedListener')] fn () => ($container->privates['App\\EventListener\\OrderStatusUpdatedListener'] ?? $container->load('getOrderStatusUpdatedListenerService')), 'onOrderStatusUpdated'], 0);
        $instance->addListener('kernel.response', [#[\Closure(name: 'App\\EventSubscriber\\SymfonyHeaderSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\SymfonyHeaderSubscriber'] ??= new \App\EventSubscriber\SymfonyHeaderSubscriber()), 'onKernelResponse'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\OrdersController', 'App\\Controller\\PingController', 'App\\Controller\\UsersController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
